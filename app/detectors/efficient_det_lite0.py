...
class EfficientDetLite0(BaseDetector):
    ...
    def _draw_text(self, image, position, text, font=cv2.FONT_HERSHEY_PLAIN, font_scale=1, font_thickness=2, text_color=(255, 255, 255), text_color_bg=(0, 0, 0)):
        x, y = position
        text_size, _ = cv2.getTextSize(text, font, font_scale, font_thickness)
        text_width, text_height = text_size
        image = cv2.rectangle(image, position, (x + text_width, y + text_height), text_color_bg, -1)
